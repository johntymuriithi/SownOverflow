    ...
    <Fragment>
        <div className='bg-slate-300 rounded-lg p-4'>
            ...
            <div className='mt-2 bg-slate-400 rounded-lg p-3 hidden md:block'>
                ...
                <div className='mt-4'>
                    <h2 className='flex items-center gap-2'><MdOutlineMarkEmailRead className='text-3xl md:text-xl'/>: <span className='font-semibold font-serif'>John Doe</span></h2>
                    <h3 className='flex items-center gap-2 break-all'><LiaUserSecretSolid className='text-4xl md:text-2xl'/>: <span className='font-semibold font-serif'>johndoe@gmarrrerrrril.com</span></h3>
                </div>
            </div>
